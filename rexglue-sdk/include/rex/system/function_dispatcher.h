...
/**
 * Re-enters guest code at `address` on the current thread's active checkpoint
 * boundary (see rex::system::PollCheckpointBoundary), matching the 360
 * kernel's trap-frame resume semantics. Defined in function_dispatcher.cpp.
 */
